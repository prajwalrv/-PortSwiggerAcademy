...
To secure applications against access control flaws, engineering teams should follow these basic principles: [1, 2] 
   ...
   3. Enforce Object Ownership: Every time a user requests an object, the server must check if that specific user session possesses legitimate ownership of that resource ID.
